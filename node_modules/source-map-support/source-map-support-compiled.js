...
exports.install = function (options) {
  if (!alreadyInstalled) {
    ...
    // directly from disk.
    if (options.retrieveFile) retrieveFile = options.retrieveFile;

    // Allow source maps to be found by methods other than reading the files
    // directly from disk.
    if (options.retrieveSourceMap) retrieveSourceMap = options.retrieveSourceMap;
...
//# sourceMappingURL=source-map-support-compiled.js.map